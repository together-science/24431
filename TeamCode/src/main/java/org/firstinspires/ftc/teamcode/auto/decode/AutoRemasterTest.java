...
@Autonomous(name = "ART v1.0.0", group="Robot")
public class AutoRemasterTest extends BaseAutoDecode {
    @Override
    protected void auto() {
        ...
        chassis.turnToHeading(ScorpChassisBase.DRIVE_SPEED_NORMAL, 30);
        fire();
