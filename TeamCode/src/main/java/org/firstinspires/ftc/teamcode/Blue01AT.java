...
public class Blue01AT extends BaseAuto25 {
    @Override
    protected void auto(){
        camera.off();
        chassis.strafeTo(0, -45, ScorpChassis.DRIVE_SPEED_FAST);
        ...
        fire(id);
        chassis.turnToHeading(ScorpChassis.DRIVE_SPEED_NORMAL, -45);
        chassis.strafeTo(-11, -65, ScorpChassis.DRIVE_SPEED_FAST);
        chassis.turnToHeading(ScorpChassis.DRIVE_SPEED_NORMAL, -145);
    }
